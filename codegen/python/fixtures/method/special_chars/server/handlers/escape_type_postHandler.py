...
User2_0_schema_resolver = jsonschema.RefResolver(
    "file://" + dir_path + "/schema/", User2_0_schema
)
User2_0_schema_validator = Draft4Validator(
    User2_0_schema, resolver=User2_0_schema_resolver
)
