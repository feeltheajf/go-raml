...
async def drones_droneId_get(request, droneId):
    """
    Get information on a specific drone
    It is handler for GET /drones/<droneId>
    """
    return handlers.drones_droneId_getHandler(request, droneId)


async def drones_droneId_patch(request, droneId):
    """
    Update the information on a specific drone
    It is handler for PATCH /drones/<droneId>
    """
    return handlers.drones_droneId_patchHandler(request, droneId)


async def drones_droneId_delete(request, droneId):
    """
    Remove a drone from the fleet
    It is handler for DELETE /drones/<droneId>
    """
    return handlers.drones_droneId_deleteHandler(request, droneId)


async def drones_droneId_deliveries_get(request, droneId):
    """
    The deliveries scheduled for the current drone
    It is handler for GET /drones/<droneId>/deliveries
    """
    return handlers.drones_droneId_deliveries_getHandler(request, droneId)
