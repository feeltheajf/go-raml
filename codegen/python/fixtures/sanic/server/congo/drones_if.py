...
class drones_bydroneIdView(HTTPMethodView):
    async def get(self, request, droneId):
        ...
        return await drones_api.drones_droneId_get(request, droneId)

    async def patch(self, request, droneId):

        return await drones_api.drones_droneId_patch(request, droneId)

    async def delete(self, request, droneId):

        return await drones_api.drones_droneId_delete(request, droneId)
...
class drones_bydroneId_deliveriesView(HTTPMethodView):
    async def get(self, request, droneId):
        ...
        return await drones_api.drones_droneId_deliveries_get(request, droneId)


drones_if.add_route(
    drones_bydroneId_deliveriesView.as_view(), "/drones/<droneId>/deliveries"
)
