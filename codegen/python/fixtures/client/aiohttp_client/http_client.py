...
class HTTPClient:
    ...
    async def do_request(
        self, uri, data, headers, params, content_type, method
    ):
    ...
    async def get(self, uri, data, headers, params, content_type):
        return await self.do_request(
            uri, data, headers, params, content_type, self.session.get
        )

    async def delete(self, uri, data, headers, params, content_type):
        return await self.do_request(
            uri, data, headers, params, content_type, self.session.delete
        )

    async def post(self, uri, data, headers, params, content_type):
        return await self.do_request(
            uri, data, headers, params, content_type, self.session.post
        )

    async def put(self, uri, data, headers, params, content_type):
        return await self.do_request(
            uri, data, headers, params, content_type, self.session.put
        )

    async def patch(self, uri, data, headers, params, content_type):
        return await self.do_request(
            uri, data, headers, params, content_type, self.session.patch
        )
