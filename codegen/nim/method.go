...
import (
	...
	cr "github.com/feeltheajf/go-raml/codegen/resource"
...
type method struct {
	...
	ResourcePath string
	ReqBody      string
	RespBody     string                  // TODO fix it as part of https://github.com/feeltheajf/go-raml/issues/350
...
func newMethod(rm cr.Method) method {
	// response body
	// TODO fix it as part of https://github.com/feeltheajf/go-raml/issues/350
	var respBody string
